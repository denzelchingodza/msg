...
export const SECTIONS = [
  ...
  { href: "/championship", n: "05", title: "Chip '26", spot: "Right corner", thumb: "/photos/kat_kisses_the_trophy.jpg", does: "The run, the art, and every parade photo. A celebration page.", verb: "Relive" },
  { href: "/faith", n: "06", title: "The Faith", spot: "The tunnel", thumb: "/photos/reed_19_brunson_11.jpg", does: "The whole story, 1946 to the parade. For fans and the unconverted.", verb: "Read" },
] as const;
